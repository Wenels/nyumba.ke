...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "Every listing has an exact pin — see the actual location before you travel.",
  },
  {
    number: "03",
    icon: Phone,
    title: "Call directly",
    description:
      "Get the landlord's number and call directly. No agent, no commission.",
  },
];
        ...
        <div className="mt-16 grid grid-cols-1 gap-12 sm:grid-cols-3">
          {STEPS.map(({ number, icon: Icon, title, description }) => (
            ...
            >
              ...
              <span className="mt-3 text-xs font-medium text-muted-foreground/50">
                {number}
              </span>
